...
public class LevelManager : MonoBehaviour
{
    ...
    public static UnityAction reloadLevelWithAd;
    public static UnityAction reloadLevel;
    
    [SerializeField] string gameID;
    //[SerializeField] string Banner_AD_ID;
   // [SerializeField] string Interstitial_AD_ID;   
   // [SerializeField] string mySurfacingId = "Rewarded Android";
    ...
    private void Start()
    {
        ...
        //reloadLevelWithAd += ReloadLevelWithAd;       
    }
    ...
    //    {
    //        //SaveManager.Instance.state.lives -= 3;
    //    }
